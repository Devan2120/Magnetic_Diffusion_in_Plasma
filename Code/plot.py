...
l = Load_file_3D(field_folder+"field_lines_l")
x = Load_file_3D(field_folder+"field_lines_x")
y = Load_file_3D(field_folder+"field_lines_y")
z = Load_file_3D(field_folder+"field_lines_z")
H = Load_file_3D(field_folder+"field_lines_H")
n=3
fig = plt.figure()
