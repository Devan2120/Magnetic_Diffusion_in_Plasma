...
open_file_fmhd(data_folder+filename)

Bx = Load_file_3D(field_folder+"Field in x")
By = Load_file_3D(field_folder+"Field in y")
Bz = Load_file_3D(field_folder+"Field in z")
...
Save_file_3D(np.asanyarray(l,dtype=object),field_folder+"field_lines_l")
Save_file_3D(np.asanyarray(x,dtype=object),field_folder+"field_lines_x")
Save_file_3D(np.asanyarray(y,dtype=object),field_folder+"field_lines_y")
Save_file_3D(np.asanyarray(z,dtype=object),field_folder+"field_lines_z")
Save_file_3D(np.asanyarray(H,dtype=object),field_folder+"field_lines_H")
